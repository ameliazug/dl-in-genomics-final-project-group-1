...
#------------------------------------------------------------------------------
What if...?
	1) Q: What happens to methylation features with no value (np.nan)?
		A: Input to the CNN model requires all features be in the range of 0-1.
		Therefore, a minmax scaling of values excluding np.nan is placed on a scale
		of .1-1, where all np.nans are replaced with 0 values.
'''
